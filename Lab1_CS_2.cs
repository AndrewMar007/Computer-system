...
namespace Lab1_1_
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int fileLength = 0;
            using (StreamReader r = new StreamReader(@"C:\Lab1\text.txt"))
            {
            ...
            Byte[] bytes;
            using (BinaryReader f1 = new BinaryReader(File.Open(@"C:\Lab1\text.txt", FileMode.Open)))
            {
            ...
            using (StreamWriter wr = new StreamWriter(@"C:\Lab1\Base64.txt", true))
            {
